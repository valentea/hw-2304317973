...
{
    Product* newP = new Book("book", prodName_, price_, qty_, isbn_, author_);
    return newP;
}
...
{
    Product* newP = new Clothing("clothing", prodName_, price_, qty_, size_, brand_);
    return newP;
}
...
{
    Product* newP = new Movie("movie", prodName_, price_, qty_, genre_, rating_);
    return newP;
}
