...
Product *ProductBookParser::makeProduct() {
    Product *tempBook = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return tempBook;
}
...
Product *ProductClothingParser::makeProduct() {
    Product *clothingTemp = new Clothing("clothing", prodName_, price_, qty_, size_, brand_);
    return clothingTemp;
}
...
Product *ProductMovieParser::makeProduct() {
    Movie *movieTemp = new Movie("movie", prodName_, price_, qty_, genre_, rating_);
    return movieTemp;
}
